...
## Сквозные ошибки студентов (быстрый чеклист)

Короткий список самых частых ошибок — удобно держать под рукой и использовать как наводящие
вопросы («а что будет, если…»).

| Тема | Типичная ошибка | Чем грозит / как объяснить |
|------|------------------|----------------------------|
